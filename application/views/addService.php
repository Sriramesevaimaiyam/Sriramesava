        ...
        <form class="form-horizontal bucket-form" action="http://localhost/srirameseva/billing/createService" id="updateCustomer" method="post" enctype="multipart/form-data">
            ...
            ?>
                ...
                <div>
                    ...
                    <input type="text" id="service" name="service" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="" placeholder="address">
                </div>
                <div>
                ...
                <div>
                    <label for="paymentMode" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Payment Mode</label>
                    <select id="paymentMode" name="paymentMode"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-500 dark:focus:border-teal-500">
                        <option value="Cash" selected="">Cash</option>
                        <option value="Upi">Upi</option>
                    </select>
                </div>
                <div>
                    <label for="status" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Payment Status</label>
                    <select id="status" name="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-500 dark:focus:border-teal-500">
                        <option value="Paid" selected="">Paid</option>
                        <option value="Unpaid">Unpaid</option>
                    </select>
                </div>
                <div>
                    <label for="payment" class="block mb-2 text-base font-medium text-gray-900 dark:text-gray-300">Payment</label>
                    <input type="text" id="payment" name="payment" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="" placeholder="">
                </div>
                </div>
