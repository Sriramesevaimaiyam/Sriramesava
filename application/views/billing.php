...
<html>
    <head>
        ...
        <title>Detailed Report - Billing -  TN Digital Seva</title>
        <!-- Favicon -->
...
<p>Line Number: 548</p>
	...
	<p>Backtrace:</p>
			...
			<p style="margin-left:10px">
			File: /home/tndigitalseva/public_html/application/libraries/BaseController.php<br />
			Line: 107<br />
			Function: view			</p>
			...
			<p style="margin-left:10px">
			File: /home/tndigitalseva/public_html/application/controllers/Billing.php<br />
			Line: 109<br />
        ...
        <div class="main-content">
            ...
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <!-- Brand -->
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="">Detailed Report - Billing</a>
                    <!-- Form -->
...
<div class="container-fluid mt--7">
    <!-- Table -->
    <div class="row" id="gst_purchase_return">
        <div class="col">
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-3">
                            <h3 class="mb-0">Detailed Report Bills</h3>
                        </div>

                        <div class="col-9 text-right">
                            <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add_cash">Opening Balance</a>
<!--                            <a href="" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#close_balance">Close Balance</a>-->
                            <a href="https://www.tndigitalseva.in/billing/billers" class="btn btn-sm btn-primary" ><i class="fas fa-user"></i> Billers</a>
                            <a href="#" class="btn btn-sm btn-success" onclick="exportTableToExcel('billing_detailed_table', 'Detailed Report Bills 2023-07-19 - 2023-07-19')"><i class="ni ni-cloud-download-95"></i> Excel</a>
                            <a href="#" class="btn btn-sm btn-info" onclick="exportTableToPdf('billing_detailed_table', 'Detailed Report Bills 2023-07-19 - 2023-07-19')"><i class="ni ni-cloud-download-95"></i> PDF</a>
                        </div>
                    </div>
                </div>
                <!-- Table -->
                        ...
                        <div class="card shadow">
                            <div class="card-header border-0">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <form action="https://www.tndigitalseva.in/billing/filter_detailed" method="post">
                                            <div class="row">
                                              ...
                                              <div class="col-md-2">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control datepicker form-control-sm" name="from_date" value="19-07-2023"></input>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control datepicker form-control-sm" name="to_date" value="19-07-2023"></input>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select class="form-control form-control-sm" name="paystatus">
                                                        <option value="0">ALL</option>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="submit" class="btn btn-primary btn-sm" value="Submit"></input>
                                                </div>
                                            </div>    
                                        </form>
                                    </div>
                            ...
                            <div class="table-responsive" style="display:block; overflow:auto; height:400px;">
                                <table id="billing_detailed_table" class="table align-items-center table-bordered" border="1px" cellspacing="0px" cellpadding="2px">
                                    ...
                                    <tbody>
                                                                                            <tr>
                                                        <td>1</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/62058" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72933');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>05:50:54 PM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td>MUKILSANJAY <br>+919976326781</td>
                                                        <!--<td>+919976326781</td>-->
                                                        <td>
                                                            TN-9320230719503                                                            <br>
                                                            Paid                                                            </td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>2</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/62056" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72931');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>05:35:48 PM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td>MOULITHARAN <br>+91919976326781</td>
                                                        <!--<td>+91919976326781</td>-->
                                                        <td>
                                                            TN-5202307199434                                                            <br>
                                                            Paid                                                            </td>
                                                        <td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>3</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/62055" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72930');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>05:35:13 PM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td>MUKILSANJAY <br>+919976326781</td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>4</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/62026" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72901');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>02:52:59 PM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td>RAVI <br>+91</td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>5</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/62020" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72894');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>01:42:17 PM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td>VASANTHI <br>+91</td>
                                                        <!--<td>+91</td>-->
                                                        <td>
                                                            2023/0103/10/396258                                                            <br>
                                                            Paid                                                            </td>
                                                        <td>
                                                            90                                                        </td>
                                                        <td>
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>6</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/62003" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72877');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>12:19:26 PM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td>ARUNA <br>+919865159876</td>
                                                        <!--<td>+919865159876</td>-->
                                                        <td>
                                                            TN-9320230719248                                                            <br>
                                                            Paid                                                            </td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>7</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/61989" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72863');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>11:43:39 AM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td> <br>+91</td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>8</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/61980" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72854');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>11:20:21 AM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td>GOPINATH <br>+91</td>
                                                        <!--<td>+91</td>-->
                                                        <td>
                                                            PANCARD                                                            <br>
                                                            Paid                                                            </td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>9</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/61979" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72853');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>11:19:49 AM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td>SANTHI <br>+91</td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>10</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/61971" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72845');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>10:52:53 AM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>system 2</td>
                                                        <td> <br>+91</td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>11</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/61970" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72844');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>10:52:36 AM
                                                        </td>
                                                        <td>Debit<br>UPI</td>
                                                        <td>system 2</td>
                                                        <td> <br>+91</td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>12</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/61969" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72843');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>10:51:12 AM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>system 2</td>
                                                        <td> <br>+91</td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>13</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/61968" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72842');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>10:48:12 AM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td>KULANDAISAMY K <br>+919361052978</td>
                                                        <!--<td>+919361052978</td>-->
                                                        <td>
                                                            TN-4202307191043                                                            <br>
                                                            Paid                                                            </td>
            ...
            0                                                        </td>
                                                        ...
                                                        <td>
                                                            0.00                                                        </td>
                                                                                                                ...
                                                                                                                <tr>
                                                        <td>14</td>
                                                        <td><a href="https://www.tndigitalseva.in/billing/receipt/61967" target="_blank">Print</a><br>
                                                            <a href="#" onclick="confirm_delete_bill('72841');">[Delete]</a></td>
                                                        <td>
                                                            19-07-2023<br>10:42:24 AM
                                                        </td>
                                                        <td>Credit<br>Cash</td>
                                                        <td>System 1</td>
                                                        <td>MOVNEESWARAN <br>+91</td>
                                                        <!--<td>+91</td>-->
                                                        <td>
                                                            TN-5202307191002                                                            <br>
                                                            Paid                                                            </td>
...
726.00                                            </td>
                ...
                <div class="modal fade" id="confirm_delete_bill_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="hidden" id="delete_bill_bdid" name="delete_bill_bdid"/>
                                        </div>
                                        <h3>Are  you sure want to delete? This process cant be undone.</h3>                             
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" data-dismiss="modal" aria-label="Close" class="btn btn-danger">Cancel</button>
                                <input type="submit" class="btn btn-danger" value="Delete" onclick="delete_bill_data();">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal fade" id="validate_delete_bill_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-confirm modal-sm">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="hidden" id="delete_bdid" name="delete_bdid"/>
                                            <input type="hidden" id="encode_otp" name="encode_otp"/><br>
                                            <label>OTP</label>
                ...
                <div id="add_cash" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <!-- Modal content-->
                        <div class="modal-content">
                            <form action="https://www.tndigitalseva.in/billing/add_cash" method="post">
                                <div class="modal-header">
                ...
                <div id="close_balance" class="modal fade" role="dialog">
                    <div class="modal-dialog">

                        <!-- Modal content-->
                        <div class="modal-content">
                            <form action="https://www.tndigitalseva.in/billing/close_balance" method="post">
                                <div class="modal-header">

                                    <h4 class="modal-title">Close Balance</h4>
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group">
    ...
    add_serivce_bill();
        ...
        $(document).ready(function () {
            $("#search_box").on("keyup", function () {
                ...
                $("#billing_detailed_table tbody tr").filter(function () {
                    $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });
        });
        function confirm_delete_bill(bdid) {
            $("#delete_bill_bdid").val(bdid);

            $('#confirm_delete_bill_modal').modal('show');
        }
        function generate_otp() {
            $('#confirm_delete_bill_modal').modal('hide');
            $('#processing').modal('show');
            var bdid = $("#delete_bill_bdid").val();
            var url = "https://www.tndigitalseva.in/billing/delete_otp/";
            $.ajax({
                url: url,
                type: "GET",
                dataType: "JSON",
                ...
                {
                    $("#delete_bdid").val(bdid);
                    $("#encode_otp").val(data);
                    $('#processing').modal('hide');
                    $('#validate_delete_bill_modal').modal('show');
                },
        ...
        function delete_bill_data() {
            $('#validate_delete_bill_modal').modal('hide');
            $('#processing').modal('show');
            var bdid = $("#delete_bill_bdid").val();
            //var bdid = $("#delete_bdid").val();
            var encode_otp = 0;//$("#encode_otp").val();
            var otp = 0;//$("#otp").val();
            var url = "https://www.tndigitalseva.in/billing/delete_bill_data/" + bdid + "/" + encode_otp + "/" + otp;
            $.ajax({
                url: url,
                type: "GET",
                dataType: "JSON",
            ...
            window.location.href = "https://www.tndigitalseva.in/billing";
